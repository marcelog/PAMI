PAMI\Message\Action\QueueAddAction
===============
...
### setStateInterface
    ...
    void PAMI\Message\Action\QueueAddAction::setStateInterface(string $stateInterface)

Sets state interface .
...
#### Arguments
* $stateInterface **string** - &lt;p&gt;State interface ... ?&lt;/p&gt;



### setPenalty

    void PAMI\Message\Action\QueueAddAction::setPenalty(string $penalty)
...
#### Arguments
* $penalty **string** - &lt;p&gt;Penalty .. ?&lt;/p&gt;



### setMemberName

    void PAMI\Message\Action\QueueAddAction::setMemberName(string $memberName)
...
#### Arguments
* $memberName **string** - &lt;p&gt;Member name ?&lt;/p&gt;



### setPaused

    void PAMI\Message\Action\QueueAddAction::setPaused(string $paused)
