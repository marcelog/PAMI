PAMI\Message\Action\RedirectAction
===============
...
### setExtraChannel
    ...
    void PAMI\Message\Action\RedirectAction::setExtraChannel(string $channel)
...
#### Arguments
* $channel **string** - &lt;p&gt;Second call leg to transfer (optional).&lt;/p&gt;



### setExtraExtension

    void PAMI\Message\Action\RedirectAction::setExtraExtension(string $extension)
...
#### Arguments
* $extension **string** - &lt;p&gt;Extension to transfer extrachannel to (optional).&lt;/p&gt;



### setExtraContext

    void PAMI\Message\Action\RedirectAction::setExtraContext(string $context)
...
#### Arguments
* $context **string** - &lt;p&gt;Context to transfer extrachannel to (optional).&lt;/p&gt;



### setExtraPriority

    void PAMI\Message\Action\RedirectAction::setExtraPriority(string $priority)
...
#### Arguments
* $priority **string** - &lt;p&gt;Priority to transfer extrachannel to (optional).&lt;/p&gt;
