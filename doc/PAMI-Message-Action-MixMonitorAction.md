PAMI\Message\Action\MixMonitorAction
===============
...
### setFile
    ...
    void PAMI\Message\Action\MixMonitorAction::setFile(string $file)
...
#### Arguments
* $file **string** - &lt;p&gt;File to use.&lt;/p&gt;



### setOptions

    void PAMI\Message\Action\MixMonitorAction::setOptions(array<mixed,string> $options)
...
#### Arguments
* $options **array&lt;mixed,string&gt;** - &lt;p&gt;List of options to use.&lt;/p&gt;
