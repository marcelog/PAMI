PAMI\Message\Action\QueueLogAction
===============
...
### setUniqueId
    ...
    void PAMI\Message\Action\QueueLogAction::setUniqueId(string $uniqueId)
...
#### Arguments
* $uniqueId **string** - &lt;p&gt;Unique Id.&lt;/p&gt;



### setMemberName

    void PAMI\Message\Action\QueueLogAction::setMemberName(string $interface)
...
#### Arguments
* $interface **string** - &lt;p&gt;Interface.&lt;/p&gt;



### setMessage

    void PAMI\Message\Action\QueueLogAction::setMessage(string $message)
